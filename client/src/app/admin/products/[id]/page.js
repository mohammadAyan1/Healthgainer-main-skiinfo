        ...
        value: (
          <span
            className={`font-semibold ${
              variant.isAvailable ? "text-green-600" : "text-red-600"
            }`}
          >
    ...
    <div className="border p-4 rounded-lg mb-4 hover:shadow-md transition-shadow">
      <div className="flex justify-between items-start">
        ...
        <div className="flex space-x-2 ml-4">
          <Link
            href={`/admin/products/${productId}/variants/${variant._id}/edit`}
          >
    ...
    <div className="p-4 bg-gray-100 min-h-screen">
      <div className="bg-white rounded-lg shadow-lg p-6 max-w-4xl mx-auto">
        <button
          ...
          className="mb-4 py-2 px-4 bg-primary text-white rounded hover:bg-primary-dark"
        >
          ← Back
        </button>
